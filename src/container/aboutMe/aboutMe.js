...
import img from "../../assets/ThatoMzangwa.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/Thato Nzangwa.pdf";
import letter from "../../assets/cv/Thato Mzangwa_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>Hello! My Name is Thato Mzangwa.</AboutMe.Heading4>
          <AboutMe.Text>
